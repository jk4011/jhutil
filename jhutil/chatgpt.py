...
daily_prompt = '''
한국어 글 교정 및 어휘 개선 해줘.
한국어로 된 글을 흐름이 원활하고 더 풍부하고 긴 글을 출력해 줘.
다양한 비유, 격언, 문학적 표현을 넣어주시면 훨씬 좋아. 
단순한 단어와 문장을 더 아름답고 우아하고 높은 수준의 단어와 문장으로 바꿔줘. 
의미는 동일하게 유지하되 좀 더 문학적으로 표현해줘. 
1인칭 관점의 글을 적어줘. 
"ㅎㅎㅎ", "ㅋㅋㅋ", "너무 좋다", "감사하다"  같은 감정적인 표현을 써주면 더 좋아. 
수정된 글을 교정만 하고, 그 외에는 설명이나 말을 하지 말아줘. 
이제 텍스트 입력을 시작할게:
'''
